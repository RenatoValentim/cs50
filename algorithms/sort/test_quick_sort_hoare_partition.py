...
from algorithms.sort.quick_sort_hoare_partition import quick_sort_hoare_partition
...
def test_in_place_quick_sort(vals, expected):
    assert quick_sort_hoare_partition(vals) == expected
